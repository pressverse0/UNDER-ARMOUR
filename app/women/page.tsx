...
export default function WomenPage() {
  ...
  const allProducts: Product[] = [
    { id: 1, name: "HeatGear Armour Sports Bra", price: 30, category: "Training", size: ["XS", "S", "M", "L", "XL"], color: ["Black", "Pink", "Purple"], rating: 4.7, reviews: 342, image: "/athletic-gear-display.png", isNew: true, inStock: true },
    { id: 2, name: "HOVR Sonic 5", price: 120, category: "Footwear", size: ["6", "7", "8", "9", "10"], color: ["White", "Pink", "Blue"], rating: 4.6, reviews: 198, image: "/athletic-gear-display.png", inStock: true },
    { id: 3, name: "Fly Fast 2.0 Tights", price: 50, originalPrice: 70, category: "Bottoms", size: ["XS", "S", "M", "L", "XL"], color: ["Black", "Navy", "Purple"], rating: 4.5, reviews: 267, image: "/athletic-gear-display.png", isSale: true, inStock: true },
    { id: 4, name: "Meridian Crop Tank", price: 35, category: "Training", size: ["XS", "S", "M", "L"], color: ["Black", "White", "Pink"], rating: 4.8, reviews: 421, image: "/athletic-gear-display.png", inStock: true },
    { id: 5, name: "Charged Pursuit 3", price: 70, category: "Footwear", size: ["6", "7", "8", "9", "10"], color: ["Black", "Gray", "Pink"], rating: 4.4, reviews: 156, image: "/athletic-gear-display.png", inStock: true },
    { id: 6, name: "Storm Windstrike Jacket", price: 100, category: "Outerwear", size: ["S", "M", "L", "XL"], color: ["Black", "Navy", "Pink"], rating: 4.6, reviews: 189, image: "/athletic-gear-display.png", isNew: true, inStock: true },
    { id: 7, name: "Infinity High Sports Bra", price: 45, category: "Training", size: ["XS", "S", "M", "L", "XL"], color: ["Black", "Purple", "Blue"], rating: 4.9, reviews: 512, image: "/athletic-gear-display.png", inStock: true },
    { id: 8, name: "Rival Fleece Hoodie", price: 55, originalPrice: 75, category: "Outerwear", size: ["S", "M", "L", "XL"], color: ["Gray", "Pink", "Black"], rating: 4.7, reviews: 298, image: "/athletic-gear-display.png", isSale: true, inStock: true },
    { id: 9, name: "Play Up 3.0 Shorts", price: 25, category: "Bottoms", size: ["XS", "S", "M", "L", "XL"], color: ["Black", "Pink", "Blue"], rating: 4.5, reviews: 234, image: "/athletic-gear-display.png", inStock: true },
    { id: 10, name: "Flow Velociti Wind 2", price: 150, category: "Footwear", size: ["6", "7", "8", "9", "10"], color: ["White", "Pink", "Purple"], rating: 4.8, reviews: 387, image: "/athletic-gear-display.png", isNew: true, inStock: true },
    { id: 11, name: "Tech Twist T-Shirt", price: 28, category: "Training", size: ["XS", "S", "M", "L", "XL"], color: ["Black", "White", "Pink", "Purple"], rating: 4.6, reviews: 445, image: "/athletic-gear-display.png", inStock: true },
    { id: 12, name: "Unstoppable Bomber Jacket", price: 110, category: "Outerwear", size: ["S", "M", "L", "XL"], color: ["Black", "Navy"], rating: 4.7, reviews: 167, image: "/athletic-gear-display.png", inStock: false },
  ]
