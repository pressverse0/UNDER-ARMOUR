...
export default function MenPage() {
  ...
  const allProducts: Product[] = [
    { id: 1, name: "HeatGear Compression Shirt", price: 35, category: "Training", size: ["S", "M", "L", "XL"], color: ["Black", "Red", "Blue"], rating: 4.5, reviews: 128, image: "/athletic-gear-display.png", isNew: true, inStock: true },
    { id: 2, name: "HOVR Phantom 3", price: 140, category: "Footwear", size: ["8", "9", "10", "11", "12"], color: ["Black", "White", "Gray"], rating: 4.8, reviews: 256, image: "/athletic-gear-display.png", inStock: true },
    { id: 3, name: "Tech 2.0 Shorts", price: 30, originalPrice: 45, category: "Bottoms", size: ["S", "M", "L", "XL"], color: ["Black", "Navy", "Gray"], rating: 4.3, reviews: 89, image: "/athletic-gear-display.png", isSale: true, inStock: true },
    { id: 4, name: "Project Rock Tank", price: 40, category: "Training", size: ["M", "L", "XL", "XXL"], color: ["Black", "Red"], rating: 4.7, reviews: 203, image: "/athletic-gear-display.png", inStock: true },
    { id: 5, name: "Charged Assert 10", price: 75, category: "Footwear", size: ["8", "9", "10", "11", "12"], color: ["Black", "Blue", "Red"], rating: 4.4, reviews: 167, image: "/athletic-gear-display.png", inStock: true },
    { id: 6, name: "Sportstyle Jacket", price: 90, category: "Outerwear", size: ["M", "L", "XL"], color: ["Black", "Navy"], rating: 4.6, reviews: 142, image: "/athletic-gear-display.png", isNew: true, inStock: true },
    { id: 7, name: "ColdGear Base Layer", price: 55, category: "Training", size: ["S", "M", "L", "XL"], color: ["Black", "Gray"], rating: 4.5, reviews: 98, image: "/athletic-gear-display.png", inStock: true },
    { id: 8, name: "Rival Fleece Hoodie", price: 50, originalPrice: 65, category: "Outerwear", size: ["M", "L", "XL", "XXL"], color: ["Black", "Gray", "Navy"], rating: 4.7, reviews: 312, image: "/athletic-gear-display.png", isSale: true, inStock: true },
    { id: 9, name: "UA RUSH Training Pants", price: 70, category: "Bottoms", size: ["S", "M", "L", "XL"], color: ["Black", "Gray"], rating: 4.6, reviews: 156, image: "/athletic-gear-display.png", inStock: true },
    { id: 10, name: "Curry Flow 11", price: 160, category: "Footwear", size: ["8", "9", "10", "11", "12"], color: ["White", "Blue", "Black"], rating: 4.9, reviews: 421, image: "/athletic-gear-display.png", isNew: true, inStock: true },
    { id: 11, name: "Tech 2.0 T-Shirt", price: 25, category: "Training", size: ["S", "M", "L", "XL", "XXL"], color: ["Black", "White", "Red", "Blue"], rating: 4.4, reviews: 267, image: "/athletic-gear-display.png", inStock: true },
    { id: 12, name: "Storm Windbreaker", price: 80, category: "Outerwear", size: ["M", "L", "XL"], color: ["Black", "Navy", "Red"], rating: 4.5, reviews: 134, image: "/athletic-gear-display.png", inStock: false },
  ]
