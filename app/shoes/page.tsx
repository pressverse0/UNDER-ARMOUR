...
export default function ShoesPage() {
  ...
  const allProducts: Product[] = [
    { id: 1, name: "HOVR Phantom 3", price: 140, category: "Running", gender: "Men", size: ["8", "9", "10", "11", "12"], color: ["Black", "White", "Gray"], rating: 4.8, reviews: 456, image: "/athletic-gear-display.png", technology: "HOVR", isNew: true, inStock: true },
    { id: 2, name: "Charged Assert 10", price: 75, category: "Running", gender: "Men", size: ["8", "9", "10", "11", "12"], color: ["Black", "Blue", "Red"], rating: 4.4, reviews: 289, image: "/athletic-gear-display.png", technology: "Charged", inStock: true },
    { id: 3, name: "Curry Flow 11", price: 160, originalPrice: 180, category: "Basketball", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["White", "Blue", "Black"], rating: 4.9, reviews: 621, image: "/athletic-gear-display.png", technology: "Flow", isSale: true, inStock: true },
    { id: 4, name: "Project Rock 5", price: 150, category: "Training", gender: "Men", size: ["8", "9", "10", "11", "12"], color: ["Black", "Red"], rating: 4.7, reviews: 398, image: "/athletic-gear-display.png", technology: "TriBase", inStock: true },
    { id: 5, name: "HOVR Sonic 5", price: 120, category: "Running", gender: "Women", size: ["6", "7", "8", "9", "10"], color: ["White", "Pink", "Blue"], rating: 4.6, reviews: 312, image: "/athletic-gear-display.png", technology: "HOVR", inStock: true },
    { id: 6, name: "Charged Pursuit 3", price: 70, category: "Running", gender: "Women", size: ["6", "7", "8", "9", "10"], color: ["Black", "Gray", "Pink"], rating: 4.5, reviews: 267, image: "/athletic-gear-display.png", technology: "Charged", isNew: true, inStock: true },
    { id: 7, name: "Flow Velociti Wind 2", price: 150, category: "Running", gender: "Women", size: ["6", "7", "8", "9", "10"], color: ["White", "Pink", "Purple"], rating: 4.8, reviews: 445, image: "/athletic-gear-display.png", technology: "Flow", inStock: true },
    { id: 8, name: "TriBase Reign 5", price: 130, originalPrice: 150, category: "Training", gender: "Men", size: ["8", "9", "10", "11", "12"], color: ["Black", "Gray"], rating: 4.7, reviews: 356, image: "/athletic-gear-display.png", technology: "TriBase", isSale: true, inStock: true },
    { id: 9, name: "Charged Bandit Trail 2", price: 110, category: "Trail", gender: "Men", size: ["8", "9", "10", "11", "12"], color: ["Black", "Green", "Gray"], rating: 4.6, reviews: 234, image: "/athletic-gear-display.png", technology: "Charged", inStock: true },
    { id: 10, name: "HOVR Machina 3", price: 170, category: "Running", gender: "Men", size: ["8", "9", "10", "11", "12"], color: ["Black", "White", "Blue"], rating: 4.9, reviews: 578, image: "/athletic-gear-display.png", technology: "HOVR", isNew: true, inStock: true },
    { id: 11, name: "Charged Rogue 3", price: 80, category: "Running", gender: "Women", size: ["6", "7", "8", "9", "10"], color: ["Black", "Pink", "White"], rating: 4.5, reviews: 389, image: "/athletic-gear-display.png", technology: "Charged", inStock: true },
    { id: 12, name: "Spawn 5", price: 120, category: "Basketball", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["Black", "Red", "White"], rating: 4.6, reviews: 298, image: "/athletic-gear-display.png", technology: "Charged", inStock: false },
  ]
