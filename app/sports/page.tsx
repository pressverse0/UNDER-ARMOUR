...
export const metadata: Metadata = {
  title: 'Sports Gear & Equipment | Under Armour',
  description: 'Shop sport-specific gear for basketball, football, running, training, and golf. Performance equipment for every athlete.',
}
