...
export const metadata: Metadata = {
  title: 'Athletic Accessories & Gear | Under Armour',
  description: 'Shop premium athletic accessories including bags, hats, gloves, and more. Complete your performance setup.',
}
