...
export default function MenPage() {
  ...
  return (
    <PageLayout activePage="men" seoTitle="Men's Athletic Clothing & Shoes | Under Armour®">
      <main className="flex-1 bg-gray-100">
        <section className="ua-hero-simple">
          <div className="ua-page-container">
            <h1 className="ua-hero-simple-h1">Men's <span className="text-red-600">Gear</span></h1>
            <p className="ua-hero-simple-sub">Engineered for athletes who demand the best.</p>
          </div>
        </section>

        <div className="ua-toolbar">
          <div className="ua-toolbar-inner">
            <SearchInput value={searchQuery} onChange={(v) => { setSearchQuery(v); setCurrentPage(1) }} placeholder="Search men's gear…" className="max-w-xs" />
