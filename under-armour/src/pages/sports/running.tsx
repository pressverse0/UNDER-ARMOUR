...
import { Search, Grid3x3, List, Zap, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function RunningPage() {
  ...
  const { products, loading, error, total } = useProducts({ categoryId: 1, perPage: 50 })
  ...
  return (
    <PageLayout activePage="sports" seoTitle="Running Shoes & Gear | Under Armour®" seoDescription="Shop Under Armour running shoes and gear. HOVR™ cushioning, moisture-wicking apparel for every runner.">
      <main className="flex-1 bg-gray-100">
        <section className="relative bg-black text-white py-12 lg:py-16 overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-gray-300 font-bold">Go the distance with performance gear. Every mile, every moment.</p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex flex-col md:flex-row gap-4 items-center">
              <div className="relative flex-1 w-full">
                ...
                <Input type="text" placeholder="Search running gear..." value={searchQuery} onChange={e => { setSearchQuery(e.target.value); setCurrentPage(1) }} className="pl-10 border-2 border-gray-300 focus:border-red-600 font-bold" />
              </div>
        ...
        <section className="container mx-auto px-4 py-6">
          <p className="font-bold text-gray-700">{loading ? 'Loading...' : `Showing ${paginated.length} of ${filtered.length} of ${total} running products`}</p>
