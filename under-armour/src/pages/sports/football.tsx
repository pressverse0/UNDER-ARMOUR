...
import { Search, Grid3x3, List, Target, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function FootballPage() {
  ...
  const { products, loading, error, total } = useProducts({ categoryId: 4, perPage: 50 })
  ...
  return (
    <PageLayout activePage="sports" seoTitle="Football Gear | Under Armour®" seoDescription="Shop Under Armour football gear. Performance cleats, pads, and apparel built for the field.">
      <main className="flex-1 bg-gray-100">
            ...
            <div className="max-w-3xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-4xl lg:text-5xl font-black uppercase leading-none tracking-tight">
                  Football <span className="text-red-600">Gear</span>
                </h1>
              </div>
              <p className="text-lg text-gray-300 font-bold">Built for the gridiron. Engineered to protect and perform.</p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex flex-col md:flex-row gap-4 items-center">
              <div className="relative flex-1 w-full">
                ...
                <Input type="text" placeholder="Search football gear..." value={searchQuery} onChange={e => { setSearchQuery(e.target.value); setCurrentPage(1) }} className="pl-10 border-2 border-gray-300 focus:border-red-600 font-bold" />
              </div>
        ...
        <section className="container mx-auto px-4 py-6">
          <p className="font-bold text-gray-700">{loading ? 'Loading...' : `Showing ${paginated.length} of ${filtered.length} of ${total} football products`}</p>
