...
export default function BasketballPage() {
  ...
  const allProducts: Product[] = [
    ...
    { id: 2, name: "Spawn 5", price: 120, category: "Shoes", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["Black", "Red", "White"], rating: 4.6, reviews: 298, image: "/ARMOUR/Curry Flow 11.jpg", inStock: true },
    ...
    { id: 4, name: "SC30 Curry Shorts", price: 45, category: "Apparel", gender: "Men", size: ["S", "M", "L", "XL"], color: ["Black", "Blue", "Gray"], rating: 4.7, reviews: 342, image: "/ARMOUR/Tech2.0Shorts.jpg", inStock: true },
    ...
    { id: 6, name: "Baseline Compression Tights", price: 50, category: "Apparel", gender: "Men", size: ["S", "M", "L", "XL"], color: ["Black", "Navy"], rating: 4.6, reviews: 234, image: "/ARMOUR/Fly Fast 2.0 Tights.jpg", inStock: true },
    ...
    { id: 10, name: "Curry Brand Socks 3-Pack", price: 20, category: "Accessories", gender: "Unisex", size: ["S", "M", "L"], color: ["White", "Black"], rating: 4.5, reviews: 512, image: "/ARMOUR/Tech Twist T-Shirt.jpg", inStock: true },
  ...
  return (
    <PageLayout activePage="sports" seoTitle="Basketball Shoes &amp; Gear | Under Armour® Curry Brand" seoDescription="Dominate the court with Under Armour basketball shoes, shorts, and jerseys. Curry Brand performance gear built for elite players.">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-gray-300 font-bold">
                Court-ready performance gear. From Curry's signature line to pro-level equipment.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex flex-col md:flex-row gap-4 items-center">
              <div className="relative flex-1 w-full">
                ...
                <Input
                  type="text"
                  placeholder="Search basketball gear..."
                  value={searchQuery}
                  onChange={(e) => {
