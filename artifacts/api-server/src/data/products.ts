...
const CATALOG: CatalogProduct[] = [
  ...
  { id: 111, name: "Girls' Infinity Sports Bra (Big Kid)",   price: 28,  category: "Kids"        },
  { id: 112, name: "Kids' Storm Windbreaker",                price: 48,  category: "Kids"        },
  ...
  { id: 207, name: "HOVR Running Belt",            price: 30,  category: "Accessories" },
  { id: 208, name: "Undeniable 5.0 Duffle Bag",   price: 55,  category: "Bags"        },
  { id: 209, name: "Liner Socks 3-Pack",           price: 14,  category: "Socks"       },
  { id: 210, name: "UA Hustle 5.0 Backpack",       price: 55,  category: "Bags"        },
  { id: 211, name: "Training Headband 2-Pack",     price: 14,  category: "Headwear"    },
  { id: 212, name: "UA 24oz Stainless Bottle",     price: 35,  category: "Hydration"   },
