...
export default function WomenPage() {
  ...
  return (
    <PageLayout activePage="women" seoTitle="Women's Athletic Clothing &amp; Shoes | Under Armour®" seoDescription="Shop women's performance activewear, sports bras, running shoes, and training gear.">
