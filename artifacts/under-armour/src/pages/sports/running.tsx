...
interface _RunningProduct extends Product {
  gender: string
}
...
export default function RunningPage() {
  ...
  const allProducts: Product[] = [
    { id: 1, name: "HOVR Phantom 3", price: 160, category: "Shoes", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["White", "Blue", "Black"], rating: 4.9, reviews: 621, image: "/ARMOUR/HOVRPhantom3.jpg", isNew: true, inStock: true },
    { id: 2, name: "HOVR Sonic 5", price: 120, category: "Shoes", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["Black", "Red", "White"], rating: 4.6, reviews: 298, image: "/ARMOUR/HOVR Sonic 5.jpg", inStock: true },
    ...
    { id: 7, name: "Flow Velociti Wind 2", price: 150, category: "Shoes", gender: "Women", size: ["6", "7", "8", "9", "10"], color: ["White", "Pink", "Purple"], rating: 4.8, reviews: 389, image: "/ARMOUR/Flow Velociti Wind 2.jpg", inStock: true },
    { id: 8, name: "Storm Windbreaker", price: 65, originalPrice: 80, category: "Apparel", gender: "Men", size: ["M", "L", "XL", "XXL"], color: ["Black", "Gray", "Navy"], rating: 4.7, reviews: 298, image: "/ARMOUR/Storm Windbreaker.jpg", isSale: true, inStock: true },
    { id: 9, name: "Running Backpack", price: 70, category: "Accessories", gender: "Unisex", size: ["One Size"], color: ["Black", "Red"], rating: 4.6, reviews: 156, image: "/ARMOUR/ProjectRockGymBag.jpg", inStock: true },
    ...
    { id: 12, name: "Meridian Crop Tank", price: 28, category: "Apparel", gender: "Women", size: ["XS", "S", "M", "L"], color: ["Black", "White", "Pink"], rating: 4.5, reviews: 267, image: "/ARMOUR/Meridian Crop Tank.jpg", inStock: false },
  ]
            ...
            <div className="max-w-3xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-4xl lg:text-5xl font-black uppercase leading-none tracking-tight">
                  Running <span className="text-red-600">Gear</span>
                </h1>
              </div>
              <p className="text-lg text-gray-300 font-bold">
                Go the distance with performance gear. Every mile, every moment.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex flex-col md:flex-row gap-4 items-center">
              <div className="relative flex-1 w-full">
                ...
                <Input
                  type="text"
                  placeholder="Search running gear..."
                  value={searchQuery}
                  onChange={(e) => {
