...
interface _TrainingProduct extends Product {
  gender: string
}
...
export default function TrainingPage() {
  ...
  const allProducts: Product[] = [
    { id: 1, name: "Project Rock Tank", price: 160, category: "Shoes", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["White", "Blue", "Black"], rating: 4.9, reviews: 621, image: "/ARMOUR/Project Rock Tank.jpg", isNew: true, inStock: true },
    { id: 2, name: "UA RUSH Training Pants", price: 120, category: "Shoes", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["Black", "Red", "White"], rating: 4.6, reviews: 298, image: "/ARMOUR/UA RUSH Training Pants.jpg", inStock: true },
    { id: 3, name: "HeatGear Compression Shirt", price: 30, originalPrice: 40, category: "Apparel", gender: "Men", size: ["S", "M", "L", "XL", "XXL"], color: ["Black", "White", "Red"], rating: 4.5, reviews: 187, image: "/ARMOUR/HeatGearCompressionShirt.jpg", isSale: true, inStock: true },
    { id: 4, name: "Tech 2.0 Shorts", price: 45, category: "Apparel", gender: "Men", size: ["S", "M", "L", "XL"], color: ["Black", "Blue", "Gray"], rating: 4.7, reviews: 342, image: "/ARMOUR/Tech2.0Shorts.jpg", inStock: true },
    { id: 5, name: "Charged Assert 10", price: 140, category: "Shoes", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["Black", "White", "Blue"], rating: 4.8, reviews: 456, image: "/ARMOUR/Charged Assert 10.jpg", isNew: true, inStock: true },
    { id: 6, name: "Fly Fast 2.0 Tights", price: 50, category: "Apparel", gender: "Men", size: ["S", "M", "L", "XL"], color: ["Black", "Navy"], rating: 4.6, reviews: 234, image: "/ARMOUR/Fly Fast 2.0 Tights.jpg", inStock: true },
    { id: 7, name: "HeatGear Armour Sports Bra", price: 150, category: "Shoes", gender: "Women", size: ["6", "7", "8", "9", "10"], color: ["White", "Pink", "Purple"], rating: 4.8, reviews: 389, image: "/ARMOUR/HeatGear Armour Sports Bra.jpg", inStock: true },
    { id: 8, name: "Rival Fleece Hoodie", price: 65, originalPrice: 80, category: "Apparel", gender: "Men", size: ["M", "L", "XL", "XXL"], color: ["Black", "Gray", "Navy"], rating: 4.7, reviews: 298, image: "/ARMOUR/Rival Fleece Hoodie.jpg", isSale: true, inStock: true },
    { id: 9, name: "Project Rock Gym Bag", price: 70, category: "Accessories", gender: "Unisex", size: ["One Size"], color: ["Black", "Red"], rating: 4.6, reviews: 156, image: "/ARMOUR/ProjectRockGymBag.jpg", inStock: true },
    { id: 10, name: "ColdGear Base Layer", price: 20, category: "Accessories", gender: "Unisex", size: ["S", "M", "L"], color: ["White", "Black"], rating: 4.5, reviews: 512, image: "/ARMOUR/ColdGear Base Layer.jpg", inStock: true },
    { id: 11, name: "Tech Twist T-Shirt", price: 35, category: "Apparel", gender: "Men", size: ["S", "M", "L", "XL", "XXL"], color: ["Black", "White", "Blue", "Red"], rating: 4.6, reviews: 423, image: "/ARMOUR/Tech Twist T-Shirt.jpg", inStock: true },
    { id: 12, name: "Infinity High Sports Bra", price: 28, category: "Apparel", gender: "Women", size: ["XS", "S", "M", "L"], color: ["Black", "White", "Pink"], rating: 4.5, reviews: 267, image: "/ARMOUR/Infinity High Sports Bra.jpg", inStock: false },
  ]

  const categories = ["Shoes", "Apparel", "Accessories"]
  const genders = ["Men", "Women", "Unisex"]
  const sizes = ["XS", "S", "M", "L", "XL", "XXL", "6", "7", "8", "9", "10", "11", "12", "13", "One Size"]
  const colors = ["Black", "White", "Red", "Blue", "Gray", "Navy", "Pink", "Purple"]
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered
  }, [allProducts, searchQuery, selectedCategories, selectedGenders, selectedSizes, selectedColors, priceRange, sortBy])
  ...
  return (
    <PageLayout activePage="sports" seoTitle="Training Apparel &amp; Shoes | Under Armour®" seoDescription="Shop Under Armour training gear — workout shirts, compression tights, training shoes, and gym bags. Built for your best workout.">
            ...
            <div className="max-w-3xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-4xl lg:text-5xl font-black uppercase leading-none tracking-tight">
                  Training <span className="text-red-600">Gear</span>
                </h1>
              </div>
              <p className="text-lg text-gray-300 font-bold">
                Gym essentials for serious athletes. Push beyond limits.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex flex-col md:flex-row gap-4 items-center">
              <div className="relative flex-1 w-full">
                ...
                <Input
                  type="text"
                  placeholder="Search training gear..."
                  value={searchQuery}
                  onChange={(e) => {
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          <div>
                            ...
                            <div className="mb-3">
                              ...
                              {product.size.length > 5 && <span className="text-xs font-bold text-gray-600">+{product.size.length - 5} more</span>}
                            </div>
