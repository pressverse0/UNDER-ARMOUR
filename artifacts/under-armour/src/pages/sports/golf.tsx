...
export default function GolfPage() {
  ...
  const allProducts: Product[] = [
    { id: 1, name: "Sportstyle Jacket", price: 160, category: "Shoes", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["White", "Blue", "Black"], rating: 4.9, reviews: 621, image: "/ARMOUR/Sportstyle Jacket.jpg", isNew: true, inStock: true },
    { id: 2, name: "Storm Windstrike Jacket", price: 120, category: "Shoes", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["Black", "Red", "White"], rating: 4.6, reviews: 298, image: "/ARMOUR/Storm Windstrike Jacket.jpg", inStock: true },
    { id: 3, name: "Tech Twist T-Shirt", price: 30, originalPrice: 40, category: "Apparel", gender: "Men", size: ["S", "M", "L", "XL", "XXL"], color: ["Black", "White", "Red"], rating: 4.5, reviews: 187, image: "/ARMOUR/Tech Twist T-Shirt.jpg", isSale: true, inStock: true },
    { id: 4, name: "Play Up 3.0 Shorts", price: 45, category: "Apparel", gender: "Men", size: ["S", "M", "L", "XL"], color: ["Black", "Blue", "Gray"], rating: 4.7, reviews: 342, image: "/ARMOUR/Play Up 3.0 Shorts.jpg", inStock: true },
    { id: 5, name: "Unstoppable Bomber Jacket", price: 140, category: "Shoes", gender: "Men", size: ["8", "9", "10", "11", "12", "13"], color: ["Black", "White", "Blue"], rating: 4.8, reviews: 456, image: "/ARMOUR/Unstoppable Bomber Jacket.jpg", isNew: true, inStock: true },
    { id: 6, name: "UA RUSH Training Pants", price: 50, category: "Apparel", gender: "Men", size: ["S", "M", "L", "XL"], color: ["Black", "Navy"], rating: 4.6, reviews: 234, image: "/ARMOUR/UA RUSH Training Pants.jpg", inStock: true },
    { id: 7, name: "Meridian Crop Tank", price: 150, category: "Shoes", gender: "Women", size: ["6", "7", "8", "9", "10"], color: ["White", "Pink", "Purple"], rating: 4.8, reviews: 389, image: "/ARMOUR/Meridian Crop Tank.jpg", inStock: true },
    ...
    { id: 11, name: "HeatGear Training Shirt", price: 35, category: "Apparel", gender: "Men", size: ["S", "M", "L", "XL", "XXL"], color: ["Black", "White", "Blue", "Red"], rating: 4.6, reviews: 423, image: "/ARMOUR/HeatGear Training Shirt.jpg", inStock: true },
            ...
            <div className="max-w-3xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-4xl lg:text-5xl font-black uppercase leading-none tracking-tight">
                  Golf <span className="text-red-600">Gear</span>
                </h1>
              </div>
              <p className="text-lg text-gray-300 font-bold">
                Precision apparel for the course. Performance meets style.
              </p>
            </div>
          </div>
        </section>
